...
{
    public partial class TiposDeAtendimento : Form
    {
        public TiposDeAtendimento()
        {
            InitializeComponent();
        ...
        Classes.TipoDeAtendimento _tipo;
        ...
        {
            codigoTextBox.Text = new TipoDeAtendimentoBO().Proximo().ToString();
            ativoCheckBox.Focus();
        }
        ...
        private void codigoTextBox_Validating(object sender, CancelEventArgs e)
        {
            ...
            _tipo = new TipoDeAtendimentoBO().Consultar(Convert.ToInt32(codigoTextBox.Text));

            if (_tipo != null)
            {
                nomeTextBox.Text = _tipo.Descricao;
        ...
        private void excluirButton_Click(object sender, EventArgs e)
        {
            ...
            if (!new TipoDeAtendimentoBO().Excluir(_tipo))
            {
        ...
        private void gravarButton_Click(object sender, EventArgs e)
        {
            ...
            _tipo.IdTipoAtendimento = Convert.ToInt32(codigoTextBox.Text);
            _tipo.Descricao = nomeTextBox.Text;
            _tipo.Ativo = ativoCheckBox.Checked;

            if (!new TipoDeAtendimentoBO().Gravar(_tipo))
            {
