...
namespace Suportte.Cadastros
{
    public partial class Departamentos : Form
    {
        ...
        private void excluirButton_Click(object sender, EventArgs e)
        {
            ...
            if (!new DepartamentoBO().Excluir(_departamento))
            {
        ...
        private void gravarButton_Click(object sender, EventArgs e)
        {
            ...
            _departamento.Id = Convert.ToInt32(codigoTextBox.Text);
            _departamento.Ativo = ativoCheckBox.Checked;
            _departamento.Descricao = nomeTextBox.Text;

            if (!new DepartamentoBO().Gravar(_departamento))
            {
        ...
        private void codigoTextBox_Validating(object sender, CancelEventArgs e)
        {
            ...
            _departamento = new DepartamentoBO().Consultar(Convert.ToInt32(codigoTextBox.Text));

            if (_departamento != null)
            {
                ativoCheckBox.Checked = _departamento.Ativo;
                nomeTextBox.Text = _departamento.Descricao;
            }

            excluirButton.Enabled = _departamento.Existe;
        ...
        {
            codigoTextBox.Text = new DepartamentoBO().Proximo().ToString();
            ativoCheckBox.Focus();
        }
