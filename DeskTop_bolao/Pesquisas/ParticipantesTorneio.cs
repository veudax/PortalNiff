...
{
    public partial class ParticipantesTorneio : Form
    {
        public ParticipantesTorneio()
        {
            InitializeComponent();
        ...
        private void confirmarButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                posFimId = value.IndexOf(", IdEmpresa");
        ...
        private void ParticipantesTorneio_Shown(object sender, EventArgs e)
        {
            List<Classes.PartidasDoTorneio> _lista = new TorneioBO().ListarPartidas(Publicas._idTorneio, Publicas._dataPesquisa);
        ...
        private void ParticipantesTorneio_Load(object sender, EventArgs e)
        {
