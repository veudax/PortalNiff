...
namespace Suportte.Pesquisas
{
    public partial class TiposDeAtendimento : Form
    {
        ...
        private void confirmarButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                posIniId = value.IndexOf("IdTipoAtendimento =") + 20;
        ...
        private void TiposDeAtendimento_Load(object sender, EventArgs e)
        {
            ...
            gridGroupingControl.DataSource = _lista.OrderBy(o => o.IdTipoAtendimento).ToList();
