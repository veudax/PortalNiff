...
namespace Suportte.Pesquisas
{
    public partial class Feedback : Form
    {
        ...
        private void confirmarButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                posIniId = value.IndexOf("MesReferencia =") + 15;
        ...
        {
            List<Classes.AutoAvaliacao> _lista = new AutoAvaliacaoBO().Listar(tipoAvaliacao, Publicas._idSuperior);

            Publicas._codigoRetornoPesquisa = string.Empty;
            Publicas._idRetornoPesquisa = 0;
            gridGroupingControl.DataSource = _lista.OrderBy(o => o.MesReferencia).ToList();
