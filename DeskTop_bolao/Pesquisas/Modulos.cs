...
namespace Suportte.Pesquisas
{
    public partial class Modulos : Form
    {
        ...
        private void confirmarButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                posIniId = value.IndexOf("IdModulo =") + 11;
                posFimId = value.IndexOf(", IdCategoria");
        ...
        private void Modulos_Load(object sender, EventArgs e)
        {
            if (Publicas._idRetornoPesquisa != 0)
            {
                ...
                RecordFilterDescriptor recordFilterDescriptor = new RecordFilterDescriptor("IdCategoria", condition);
            ...
            Publicas._idRetornoPesquisa = 0;
            List<Modulo> _lista = new ModuloBO().Listar();

            gridGroupingControl.DataSource = _lista.OrderBy(o => o.IdModulo).ToList();
            ...
            //GridExcelFilter filter = new GridExcelFilter(); // tipo excel
