...
{
    public partial class CentroDeCustoContabil : Form
    {
        public CentroDeCustoContabil()
        {
            InitializeComponent();
        ...
        private void CentroDeCustoContabil_Load(object sender, EventArgs e)
        {
        ...
        private void confirmarButton_Click(object sender, EventArgs e)
        {
            try
            {
                if (_registro != null)
                {
                    ...
                    if (dr != null)
                        Publicas._idRetornoPesquisa = (int)dr["Codigo"];
                }
        ...
        private void CentroDeCustoContabil_Shown(object sender, EventArgs e)
        {
            mensagemSistemaLabel.Text = "Pesquisando centro de custo no Globus...";
            this.UseWaitCursor = true;
            this.Refresh();

            List<Classes.CentroDeCustoContabil> _lista;

            _lista = new CentroDeCustoContabilBO().Listar(Publicas._codigoRetornoPesquisa);

            gridGroupingControl.DataSource = _lista.OrderBy(o => o.Classificador).ToList();
