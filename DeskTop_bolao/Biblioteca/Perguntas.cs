...
namespace Suportte.Biblioteca
{
    public partial class Perguntas : Form
    {
        ...
        private void codigoTextBox_Validating(object sender, CancelEventArgs e)
        {
            ...
            _resenhaAnterior = new ResenhaLivrosBO().Consultar(_livros.Id);
            ...
            if (_resenhaAnterior.Existe && _resenhaAnterior.IdColaborador != Publicas._idColaborador && 
                !string.IsNullOrEmpty(_resenha.Resenha) && _perguntasAnteriores.Count() != 0)
            {
