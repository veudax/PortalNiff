...
namespace Suportte.Cadastros
{
    public partial class TiposDePagamento : Form
    {
        ...
        private void excluirButton_Click(object sender, EventArgs e)
        {
            ...
            if (!new TipoDePagamentoBO().Excluir(_tipo))
            {
        ...
        private void gravarButton_Click(object sender, EventArgs e)
        {
            ...
            _tipo.Id = Convert.ToInt32(codigoTextBox.Text);
            _tipo.Ativo = ativoCheckBox.Checked;
            _tipo.Descricao = nomeTextBox.Text;

            if (!new TipoDePagamentoBO().Gravar(_tipo))
            {
        ...
        private void codigoTextBox_Validating(object sender, CancelEventArgs e)
        {
            ...
            _tipo = new TipoDePagamentoBO().Consultar(Convert.ToInt32(codigoTextBox.Text));
        ...
        {
            codigoTextBox.Text = new TipoDePagamentoBO().Proximo().ToString();
            ativoCheckBox.Focus();
        }
