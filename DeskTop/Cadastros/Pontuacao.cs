    ...
    public partial class Pontuacao : Form
    {
        public Pontuacao()
        {
            ...
            if (Publicas._alterouSkin)
            {
                ...
                {
                    gridGroupingControl.GridOfficeScrollBars = OfficeScrollBars.Office2016;
                    ...
                    superaCurrencyTextBox.PositiveColor = Publicas._fonte;
                    naoAtendeCurrencyTextBox.PositiveColor = Publicas._fonte;
                    atendeParcialmenteCurrencyTextBox.PositiveColor = Publicas._fonte;
                    atendePlenamenteCurrencyTextBox.PositiveColor = Publicas._fonte;
                }
            }
