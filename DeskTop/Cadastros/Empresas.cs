...
namespace Suportte.Cadastros
{
    public partial class Empresas : Form
    {
        public Empresas()
        {
            ...
            AtentendeRespCurrencyTextBox.BackGroundColor = emailTextBox.BackColor;
            ...
            if (Publicas._alterouSkin)
            {
                ...
                {
                    emailGridGroupingControl.GridOfficeScrollBars = OfficeScrollBars.Office2010;
                    emailGridGroupingControl.ColorStyles = ColorStyles.Office2010Black;
                    emailGridGroupingControl.GridVisualStyles = GridVisualStyles.Office2016Black;
                    emailGridGroupingControl.BackColor = Publicas._panelTitulo;

                    responderCurrencyTextBox.PositiveColor = Publicas._fonte;
                    cancelarCurrencyTextBox.PositiveColor = Publicas._fonte;
                    semRetornoCurrencyTextBox.PositiveColor = Publicas._fonte;
                    valorDescontarInjustificadasCurrencyTextBox.PositiveColor = Publicas._fonte;
                    valorJustificadasCurrencyTextBox.PositiveColor = Publicas._fonte;
                    quantidadeAplicarInjustificadasCurrencyTextBox.PositiveColor = Publicas._fonte;
                    quantidadeFaltasAplicarCurrencyTextBox.PositiveColor = Publicas._fonte;
                    AtentendeRespCurrencyTextBox.PositiveColor = Publicas._fonte;
                }
            }
        ...
        private void empresaTextBox_Validating(object sender, CancelEventArgs e)
        {
            ...
            if (_empresa != null)
            {
                ...
                Zero800CheckBox.Checked = _empresa.Zero800;
                ...
                AtentendeRespCurrencyTextBox.DecimalValue = _empresa.AtendenteRespEmDiasSAC;
        ...
        private void limparButton_Click(object sender, EventArgs e)
        {
            ...
            tabControlAdv1.SelectedTab = EmailtabPageAdv;
            Zero800CheckBox.Checked = false;
            AtentendeRespCurrencyTextBox.DecimalValue = 0;
            empresaTextBox.Focus();
        }
        ...
        private void gravarButton_Click(object sender, EventArgs e)
        {
            ...
            _empresa.Zero800 = Zero800CheckBox.Checked;
            _empresa.AtendenteRespEmDiasSAC = Convert.ToInt32(AtentendeRespCurrencyTextBox.DecimalValue);
        ...
        private void Zero800CheckBox_CheckStateChanged(object sender, EventArgs e)
        {
            if (Zero800CheckBox.Checked)
            {
                label27.Text = "Telefone SAC 0800";
                telefoneMaskedEditBox.Mask = "9999-999-9999";
            }
            else
            {
                label27.Text = "Telefone SAC";
                telefoneMaskedEditBox.Mask = "(99) 9999-9999";
            }
        }
    }
}
