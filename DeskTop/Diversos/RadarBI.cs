...
namespace Suportte.Diversos
{
    public partial class RadarBI : Form
    {
        ...
        private void RadarBI_Load(object sender, EventArgs e)
        {
            ...
            rubricaComboBoxAdv.Items.Add(Publicas.GetDescription(Publicas.RadarBI.CumprimentoDePartida, ""));
            rubricaComboBoxAdv.Items.Add(Publicas.GetDescription(Publicas.RadarBI.CarrosRetidos, ""));
        ...
        private void gravarButton_Click(object sender, EventArgs e)
        {
            ...
            switch (rubricaComboBoxAdv.SelectedIndex)
            {
                ...
                case 9:
                    ...
                    break;
                case 10:
                    tipo = Publicas.GetDescription(Publicas.TipoRadarBI.CumprimentoDePartida, "");
                    ordem = Publicas.GetDescription(Publicas.OrdemRadarBI.CumprimentoDePartida, "");
                    break;
                case 11:
                    tipo = Publicas.GetDescription(Publicas.TipoRadarBI.CarrosRetidos, "");
                    ordem = Publicas.GetDescription(Publicas.OrdemRadarBI.CarrosRetidos, "");
                    break;
            }
