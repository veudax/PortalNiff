...
{
    public partial class LeiGlobus : Form
    {
        public LeiGlobus() 
        {
            InitializeComponent();
        ...
        private void LeiGlobus_Shown(object sender, EventArgs e)
        {
            List<Classes.LeiGlobus> _lista = new List<Classes.LeiGlobus>();

            _lista = new CFOPGlobusBO().ListarLeisGlobus();
        ...
        private void LeiGlobus_Load(object sender, EventArgs e)
        {
