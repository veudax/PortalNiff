...
{
    public partial class BancoGlobus : Form
    {
        public BancoGlobus()
        {
            InitializeComponent();
        ...
        private void BancoGlobus_Shown(object sender, EventArgs e)
        {
            List<Classes.Financeiro.BancosGlobus> _lista = new FinanceiroBO().ListarBancosGlobus(Publicas._codigoEmpresaGlobus);
        ...
        private void BancoGlobus_Load(object sender, EventArgs e)
        {
