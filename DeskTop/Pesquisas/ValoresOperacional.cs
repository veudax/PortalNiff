...
{
    public partial class ValoresOperacional : Form
    {
        public ValoresOperacional()
        {
            InitializeComponent();
        ...
        private void ValoresOperacional_Shown(object sender, EventArgs e)
        {
            List<Classes.Operacional.Valores> _lista = new OperacionalBO().Listar(Publicas._idEmpresa);
        ...
        private void ValoresOperacional_Load(object sender, EventArgs e)
        {
