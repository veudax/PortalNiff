...
{
    public partial class Escolaridade : Form
    {
        public Escolaridade()
        {
            InitializeComponent();
        ...
        private void Escolaridade_Shown(object sender, EventArgs e)
        {
            List<Classes.Escolaridade> _lista = new EscolaridadeBO().Listar();
        ...
        private void Escolaridade_Load(object sender, EventArgs e)
        {
