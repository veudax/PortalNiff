...
{
    public partial class CategoriaLivros : Form
    {
        ...
        private void Categorias_Shown(object sender, EventArgs e)
        {
            List<Classes.CategoriaLivros> _lista = new CategoriaLivrosBO().Listar();
