...
{
    public partial class OperacaoGlobus : Form
    {
        public OperacaoGlobus()
        {
            InitializeComponent();
        ...
        private void OperacaoGlobus_Shown(object sender, EventArgs e)
        {
            List<Classes.OperacaoGlobus> _lista = new CFOPGlobusBO().ListarOperacao();
        ...
        private void OperacaoGlobus_Load(object sender, EventArgs e)
        {
