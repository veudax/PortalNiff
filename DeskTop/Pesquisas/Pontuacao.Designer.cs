namespace Suportte.Pesquisas
{
    partial class Pontuacao
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.tituloLabel.Text = "Pesquisa de pontuação";
            ...
            gridColumnDescriptor17.Appearance.AnyRecordFieldCell.CellValueType = typeof(int);
            ...
            gridColumnDescriptor17.HeaderText = "Código";
            gridColumnDescriptor17.MappingName = "Id";
            gridColumnDescriptor17.Width = 96;
            ...
            gridColumnDescriptor18.HeaderText = "Referência";
            gridColumnDescriptor18.MappingName = "MesReferenciaFormatada";
            gridColumnDescriptor18.Width = 110;
            gridColumnDescriptor19.Appearance.AnyRecordFieldCell.AutoSize = true;
            gridColumnDescriptor19.Appearance.AnyRecordFieldCell.CellValueType = typeof(int);
            ...
            gridColumnDescriptor19.HeaderText = "Teto";
            gridColumnDescriptor19.MappingName = "Base100";
            ...
            gridColumnDescriptor20.MappingName = "Piso";
            gridColumnDescriptor21.Appearance.AnyRecordFieldCell.AutoSize = true;
            gridColumnDescriptor21.Appearance.AnyRecordFieldCell.CellValueType = typeof(int);
            ...
            gridColumnDescriptor21.Appearance.ColumnHeaderCell.HorizontalAlignment = Syncfusion.Windows.Forms.Grid.GridHorizontalAlignment.Right;
            gridColumnDescriptor21.HeaderText = "Não Atende";
            gridColumnDescriptor21.MappingName = "NaoAtende";
            gridColumnDescriptor21.Width = 90;
            gridColumnDescriptor22.Appearance.AnyRecordFieldCell.AutoSize = true;
            gridColumnDescriptor22.Appearance.AnyRecordFieldCell.CellValueType = typeof(int);
            gridColumnDescriptor22.Appearance.AnyRecordFieldCell.HorizontalAlignment = Syncfusion.Windows.Forms.Grid.GridHorizontalAlignment.Right;
            ...
            gridColumnDescriptor22.Appearance.ColumnHeaderCell.HorizontalAlignment = Syncfusion.Windows.Forms.Grid.GridHorizontalAlignment.Right;
            gridColumnDescriptor22.HeaderText = "Atende Parcialmente";
            gridColumnDescriptor22.MappingName = "AtendeParcialmente";
            gridColumnDescriptor22.Width = 140;
            gridColumnDescriptor23.Appearance.AnyRecordFieldCell.AutoSize = true;
            gridColumnDescriptor23.Appearance.AnyRecordFieldCell.CellValueType = typeof(int);
            gridColumnDescriptor23.Appearance.AnyRecordFieldCell.HorizontalAlignment = Syncfusion.Windows.Forms.Grid.GridHorizontalAlignment.Right;
            ...
            gridColumnDescriptor23.Appearance.ColumnHeaderCell.HorizontalAlignment = Syncfusion.Windows.Forms.Grid.GridHorizontalAlignment.Right;
            gridColumnDescriptor23.HeaderText = "Atende Plenamente";
            gridColumnDescriptor23.MappingName = "AtendePlenamente";
            gridColumnDescriptor23.Width = 130;
            gridColumnDescriptor24.Appearance.AnyRecordFieldCell.AutoSize = true;
            gridColumnDescriptor24.Appearance.AnyRecordFieldCell.CellValueType = typeof(int);
            gridColumnDescriptor24.Appearance.AnyRecordFieldCell.HorizontalAlignment = Syncfusion.Windows.Forms.Grid.GridHorizontalAlignment.Right;
            ...
            gridColumnDescriptor24.Appearance.ColumnHeaderCell.HorizontalAlignment = Syncfusion.Windows.Forms.Grid.GridHorizontalAlignment.Right;
            gridColumnDescriptor24.MappingName = "Supera";
            ...
            new Syncfusion.Grouping.SortColumnDescriptor("OrdemReferencia", System.ComponentModel.ListSortDirection.Ascending)});
            ...
            new Syncfusion.Windows.Forms.Grid.Grouping.GridVisibleColumnDescriptor("MesReferenciaFormatada"),
            new Syncfusion.Windows.Forms.Grid.Grouping.GridVisibleColumnDescriptor("Base100"),
            new Syncfusion.Windows.Forms.Grid.Grouping.GridVisibleColumnDescriptor("Piso"),
            new Syncfusion.Windows.Forms.Grid.Grouping.GridVisibleColumnDescriptor("NaoAtende"),
            new Syncfusion.Windows.Forms.Grid.Grouping.GridVisibleColumnDescriptor("AtendeParcialmente"),
            new Syncfusion.Windows.Forms.Grid.Grouping.GridVisibleColumnDescriptor("AtendePlenamente"),
            new Syncfusion.Windows.Forms.Grid.Grouping.GridVisibleColumnDescriptor("Supera")});
            ...
            this.Shown += new System.EventHandler(this.Vara_Shown);
