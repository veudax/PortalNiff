...
namespace Suportte.Pesquisas
{
    public partial class Veiculos : Form
    {
        ...
        private void confirmarButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                posIniId = value.IndexOf("Prefixo =") + 9;
        ...
        private void Veiculos_Shown(object sender, EventArgs e)
        {
            List<Classes.VeiculosGlobus> _lista = new VeiculosGlobusBO().Listar(Publicas._codigoEmpresaGlobus);
            Publicas._codigoRetornoPesquisa = string.Empty;
            Publicas._idRetornoPesquisa = 0;
            gridGroupingControl.DataSource = _lista.OrderBy(o => o.Prefixo).ToList();
