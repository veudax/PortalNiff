...
{
    public partial class VigenciasDosIndicadores : Form
    {
        public VigenciasDosIndicadores()
        {
            InitializeComponent();
        ...
        private void confirmarButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                posIniId = value.IndexOf("Data =") + 6;
                posFimId = value.IndexOf(", Peso");
        ...
        private void VigenciasDosIndicadores_Shown(object sender, EventArgs e)
        {
            List<Classes.Operacional.Metas> _lista = new OperacionalBO().ListarMetas(Publicas._idEmpresa, Publicas._idRetornoPesquisa);
        ...
        private void VigenciasDosIndicadores_Load(object sender, EventArgs e)
        {
