...
{
    public partial class EmailBI : Form
    {
        public EmailBI()
        {
            InitializeComponent();
        ...
        private void confirmarButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                posIniId = value.IndexOf("Email =") + 7;
        ...
        private void EmailBI_Shown(object sender, EventArgs e)
        {
            List<Classes.PowerBI.EmailDeAcesso> _lista = new PowerBIBO().Listar(false);
        ...
        private void EmailBI_Load(object sender, EventArgs e)
        {
