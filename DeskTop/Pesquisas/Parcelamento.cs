...
namespace Suportte.Pesquisas
{
    public partial class Parcelamento : Form
    {
        ...
        private void confirmarButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                posIniId = value.IndexOf("NumeroContrato =") + 16;
                posFimId = value.IndexOf(", Pedido");
        ...
        {
            List<Classes.Endividamento.Contrato> _lista = new EndividamentoBO().Listar(Publicas._idEmpresa, Publicas._codigoPesquisa, Publicas._tipoDespesaReceita);
            Publicas._codigoRetornoPesquisa = string.Empty;
            Publicas._idRetornoPesquisa = 0;
            gridGroupingControl.DataSource = _lista.OrderBy(o => o.NumeroContrato).ToList();
