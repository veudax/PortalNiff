...
{
    public partial class PlanoContabil : Form
    {
        public PlanoContabil()
        {
            InitializeComponent();
        ...
        private void confirmarButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                posIniId = value.IndexOf("NumeroPlano =") + 13;
        ...
        private void PlanoContabil_Shown(object sender, EventArgs e)
        {
            List<Classes.RateioBeneficios.PlanoContabil> _lista = new RateioBeneficioBO().Listar();
        ...
        private void PlanoContabil_Load(object sender, EventArgs e)
        {
