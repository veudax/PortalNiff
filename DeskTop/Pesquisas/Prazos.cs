...
namespace Suportte.Pesquisas
{
    public partial class Prazos : Form
    {
        ...
        {
            List<Classes.Prazos> _lista = new PrazosBO().Listar();
            Publicas._codigoRetornoPesquisa = string.Empty;
            Publicas._idRetornoPesquisa = 0;
            gridGroupingControl.DataSource = _lista.OrderBy(o => o.Referencia).ToList();
        ...
        private void Prazos_Load(object sender, EventArgs e)
        {
