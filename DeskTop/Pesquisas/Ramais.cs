...
namespace Suportte.Pesquisas
{
    public partial class Ramais : Form
    {
        ...
        private void confirmarButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                posIniId = value.IndexOf("Numero =") + 8;
                posFimId = value.IndexOf(", Grupo");
        ...
        {
            List<Classes.Ramais> _lista;

            _lista = new RamaisBO().ListarRamais(Publicas._telefone);

            Publicas._codigoRetornoPesquisa = string.Empty;
            Publicas._idRetornoPesquisa = 0;
            gridGroupingControl.DataSource = _lista.OrderBy(o => o.Numero).ToList();
