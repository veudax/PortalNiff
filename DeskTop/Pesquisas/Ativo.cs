...
{
    public partial class Ativo : Form
    {
        public Ativo()
        {
            InitializeComponent();
        ...
        private void confirmarButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                posFimId = value.IndexOf(", Conta");
                Publicas._codigoRetornoPesquisa = value.Substring(posIniId, posFimId - posIniId).Trim();

                posIniId = value.IndexOf("Empresa =") + 10;
                posFimId = value.IndexOf(", IdEmpresa");
                Publicas._codigoEmpresaGlobus = value.Substring(posIniId, posFimId - posIniId).Trim();
        ...
        private void Ativo_Shown(object sender, EventArgs e)
        {
            Publicas._codigoRetornoPesquisa = string.Empty;
            Publicas._idRetornoPesquisa = 0;
            mensagemSistemaLabel.Text = "Pesquisando itens do ativo...";
            this.UseWaitCursor = true;
            this.Refresh();

            List<ConciliacaoContabil.Ativo.ItemAtivo> _lista;

            // Empresa do usuario logado
            _lista = new ConciliacaoContabilBO().Listar(Publicas._idEmpresa, Publicas._consolidar);
        ...
        private void Ativo_Load(object sender, EventArgs e)
        {
