...
{
    public partial class SalaDeReuniao : Form
    {
        ...
        private void confirmarButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                posIniId = value.IndexOf("IdSala =") + 9;
                posFimId = value.IndexOf(", Codigo");
        ...
        private void SalaDeReuniao_Load(object sender, EventArgs e)
        {
            ...
            Publicas._idRetornoPesquisa = 0;
            List<Classes.SalaDeReuniao> _lista = new SalaDeReuniaoBO().Listar();

            gridGroupingControl.DataSource = _lista.OrderBy(o => o.IdSala).ToList();
