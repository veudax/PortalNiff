...
namespace Suportte.Pesquisas
{
    public partial class RelatoriosBI : Form
    {
        ...
        private void RelatoriosBI_Shown(object sender, EventArgs e)
        {
            List<Classes.PowerBI.Relatorios> _lista = new PowerBIBO().ListarRelatorios(false);
        ...
        private void RelatoriosBI_Load(object sender, EventArgs e)
        {
