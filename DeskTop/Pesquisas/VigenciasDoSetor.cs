...
{
    public partial class VigenciasDoSetor : Form
    {
        public VigenciasDoSetor()
        {
            InitializeComponent();
        ...
        private void confirmarButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                posFimId = value.IndexOf(", CodigoLinha");
        ...
        private void VigenciasDoSetor_Shown(object sender, EventArgs e)
        {
            List<Classes.Operacional.Vigencia> _lista = new OperacionalBO().ListarVigencias(Publicas._idRetornoPesquisa, true);
        ...
        private void VigenciasDoSetor_Load(object sender, EventArgs e)
        {
