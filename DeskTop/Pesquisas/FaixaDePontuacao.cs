...
namespace Suportte.Pesquisas
{
    public partial class FaixaDePontuacao : Form
    {
        ...
        {
            List<Classes.Operacional.Pontuacao> _lista = new OperacionalBO().Listar(false, Publicas._idEmpresa);
        ...
        private void FaixaDePontuacao_Load(object sender, EventArgs e)
        {
