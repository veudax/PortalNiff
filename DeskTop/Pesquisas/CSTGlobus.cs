...
{
    public partial class CSTGlobus : Form
    {
        public CSTGlobus()
        {
            InitializeComponent();
        ...
        private void CSTGlobus_Shown(object sender, EventArgs e)
        {
            List<Classes.CSTGlobus> _lista = new CFOPGlobusBO().ListarCST();
        ...
        private void CSTGlobus_Load(object sender, EventArgs e)
        {
