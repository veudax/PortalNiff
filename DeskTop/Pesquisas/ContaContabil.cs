...
{
    public partial class ContaContabil : Form
    {
        ...
        private void ContaContabil_Shown(object sender, EventArgs e)
        {
            List<Classes.RateioBeneficios.ContasContabeis> _lista = new RateioBeneficioBO().Listar(Publicas._idRetornoPesquisa);
        ...
        private void ContaContabil_Load(object sender, EventArgs e)
        {
