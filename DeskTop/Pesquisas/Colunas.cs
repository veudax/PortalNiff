...
namespace Suportte.Pesquisas
{
    public partial class Colunas : Form
    {
        ...
        private void Colunas_Shown(object sender, EventArgs e)
        {
            List<Classes.Financeiro.Colunas> _lista = new FinanceiroBO().Listar(false);
        ...
        private void Colunas_Load(object sender, EventArgs e)
        {
