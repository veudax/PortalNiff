...
{
    public partial class SetorDasLinhas : Form
    {
        public SetorDasLinhas()
        {
            InitializeComponent();
        ...
        private void confirmarButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                posIniId = value.IndexOf("Codigo =") + 8;
        ...
        private void SetorDasLinhas_Shown(object sender, EventArgs e)
        {
            List<Classes.Operacional.Setor> _lista = new OperacionalBO().ListarSetores(false, Publicas._idEmpresa);
        ...
        private void SetorDasLinhas_Load(object sender, EventArgs e)
        {
