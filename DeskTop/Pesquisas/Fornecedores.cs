...
namespace Suportte.Pesquisas
{
    public partial class Fornecedores : Form
    {
        public Fornecedores()
        {
            ...
            if (Publicas._alterouSkin)
            {
                ...
                if (Publicas._TemaBlack)
                {
                    ...
                    mensagemSistemaLabel.BackColor = tituloPanel.BackColor;
                }
            }
        }
        ...
        private void confirmarButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                posIniId = value.IndexOf("Numero =") + 9;
                posFimId = value.IndexOf(", NomeFantasia");
        ...
        private void Fornecedores_Shown(object sender, EventArgs e)
        {
            ...
            mensagemSistemaLabel.Text = "Pesquisando fornecedores...";
            this.UseWaitCursor = true;
            this.Refresh();

            List<FornecedoresGlobus> _lista;

            // Empresa do usuario logado
            _lista = new FornecedoresGlobusBO().Listar();

            gridGroupingControl.DataSource = _lista.OrderBy(o => o.NomeFantasia).ToList();
