...
namespace Suportte.Pesquisas
{
    public partial class Funcionarios : Form
    {
        ...
        private void Funcionarios_Shown(object sender, EventArgs e)
        {
            Publicas._codigoRetornoPesquisa = string.Empty;
            Publicas._idRetornoPesquisa = 0;
            mensagemSistemaLabel.Text = "Pesquisando funcionários...";
            this.UseWaitCursor = true;
            this.Refresh();

            List<FuncionariosGlobus> _lista;

            // Empresa do usuario logado
            _lista = new FuncionariosGlobusBO().Listar(Publicas._codigoEmpresaGlobus, Publicas._idSuperior, Publicas._participaAvaliacao);
