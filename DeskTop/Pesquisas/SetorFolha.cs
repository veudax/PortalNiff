...
{
    public partial class SetorFolha : Form
    {
        public SetorFolha()
        {
            InitializeComponent();
        ...
        private void SetorFolha_Shown(object sender, EventArgs e)
        {
            List<Classes.RateioBeneficios.Setor> _lista = new RateioBeneficioBO().ListarSetores();
        ...
        private void SetorFolha_Load(object sender, EventArgs e)
        {
