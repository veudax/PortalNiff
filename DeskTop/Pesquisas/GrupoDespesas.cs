...
{
    public partial class GrupoDespesas : Form
    {
        ...
        private void GrupoDespesas_Shown(object sender, EventArgs e)
        {
            List<Classes.ConferenciaNotasPelaContabilidade.GrupoDespesas> _lista = new ConferenciaNotasPelaContabilidadeBO().ListarGrupo();
        ...
        private void GrupoDespesas_Load(object sender, EventArgs e)
        {
