...
{
    public partial class VigenciasDaPontuacao : Form
    {
        public VigenciasDaPontuacao()
        {
            InitializeComponent();
        ...
        private void VigenciasDaPontuacao_Shown(object sender, EventArgs e)
        {
            List<Classes.Operacional.VigenciaPontuacao> _lista = new OperacionalBO().ListarVigenciasPontuacao(Publicas._idRetornoPesquisa);
        ...
        private void VigenciasDaPontuacao_Load(object sender, EventArgs e)
        {
