...
{
    public partial class TipoDeFrota : Form
    {
        public TipoDeFrota()
        {
            InitializeComponent();
        ...
        private void TipoDeFrota_Shown(object sender, EventArgs e)
        {
            List<Classes.TipoDeFrota> _lista = new OcorrenciasGlobusBO().ListarTipoDeFrota();
        ...
        private void TipoDeFrota_Load(object sender, EventArgs e)
        {
