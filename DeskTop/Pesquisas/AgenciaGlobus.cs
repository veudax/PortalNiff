...
{
    public partial class AgenciaGlobus : Form
    {
        public AgenciaGlobus()
        {
            InitializeComponent();
        ...
        private void AgenciaGlobus_Shown(object sender, EventArgs e)
        {
            List<Classes.Financeiro.AgenciaGlobus> _lista = new FinanceiroBO().ListarAgenciaGlobus(Publicas._idRetornoPesquisa, Publicas._codigoEmpresaGlobus);
        ...
        private void AgenciaGlobus_Load(object sender, EventArgs e)
        {
