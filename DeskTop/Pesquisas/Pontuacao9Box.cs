...
{
    public partial class Pontuacao9Box : Form
    {
        public Pontuacao9Box()
        {
            InitializeComponent();
        ...
        private void confirmarButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                posFimId = value.IndexOf(", Referencia");
        ...
        private void Pontuacao9Box_Shown(object sender, EventArgs e)
        {
            List<Classes.Pontuacao9Box> _lista;
            
            if (Publicas._porCargo)
                _lista = new Pontuacao9BoxBO().Listar(false, Publicas._idComunicado, 0);
            else
                _lista = new Pontuacao9BoxBO().Listar(false, 0, Publicas._idComunicado);

            Publicas._codigoRetornoPesquisa = string.Empty;
            Publicas._idRetornoPesquisa = 0;
            gridGroupingControl.DataSource = _lista.ToList();
        ...
        private void Pontuacao9Box_Load(object sender, EventArgs e)
        {
