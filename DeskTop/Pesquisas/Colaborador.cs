    ...
    public partial class Colaborador : Form
    {
        ...
        private void confirmarButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                posFimId = value.IndexOf(", CodigoInternoFuncionarioGlobus");
        ...
        private void Vara_Shown(object sender, EventArgs e)
        {
            if (Publicas._idEmpresa == 0)
                Publicas._idEmpresa = 1;

            List<Classes.Colaboradores> _lista = new ColaboradoresBO().ListarColaboradoresBolao(Publicas._idEmpresa);
