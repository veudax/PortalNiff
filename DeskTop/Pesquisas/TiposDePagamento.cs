...
{
    public partial class TiposDePagamento : Form
    {
        ...
        private void TiposDePagamento_Shown(object sender, EventArgs e)
        {
            List<TipoDePagamento> _lista = new TipoDePagamentoBO().Listar();
            Publicas._codigoRetornoPesquisa = string.Empty;
            Publicas._idRetornoPesquisa = 0;
            gridGroupingControl.DataSource = _lista.OrderBy(o => o.Id).ToList();
        ...
        private void TiposDePagamento_Load(object sender, EventArgs e)
        {
