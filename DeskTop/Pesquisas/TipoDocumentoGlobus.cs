...
{
    public partial class TipoDocumentoGlobus : Form
    {
        public TipoDocumentoGlobus()
        {
            InitializeComponent();
        ...
        private void TipoDocumentoGlobus_Shown(object sender, EventArgs e)
        {
            List<Classes.TipoDocumentoGlobus> _lista = new TipoDocumentoGlobusBO().Listar(Publicas._codigoEmpresaGlobus);
        ...
        private void TipoDocumentoGlobus_Load(object sender, EventArgs e)
        {
