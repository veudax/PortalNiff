...
{
    public partial class ParametrosAtivo : Form
    {
        public ParametrosAtivo()
        {
            InitializeComponent();
        ...
        private void confirmarButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                posFimId = value.IndexOf(", CodigoAtivo");
        ...
        private void ParametrosAtivo_Shown(object sender, EventArgs e)
        {
            Publicas._codigoRetornoPesquisa = string.Empty;
            Publicas._idRetornoPesquisa = 0;
            mensagemSistemaLabel.Text = "Pesquisando parâmetros do ativo...";
            this.UseWaitCursor = true;
            this.Refresh();

            List<ConciliacaoContabil.Ativo.Parametros> _lista;

            // Empresa do usuario logado
            _lista = new ConciliacaoContabilBO().ListarParametros(Publicas._idEmpresa, true, Publicas._consolidar);

            gridGroupingControl.DataSource = _lista.OrderBy(o => o.Codigo).ToList();
        ...
        private void ParametrosAtivo_Load(object sender, EventArgs e)
        {
