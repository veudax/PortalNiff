...
{
    public partial class RelatoriosBI : Form
    {
        public RelatoriosBI()
        {
            InitializeComponent();
        ...
        private void codigoTextBox_Validating(object sender, CancelEventArgs e)
        {
            ...
            {
                ativoCheckBox.Checked = _relatorio.Ativo;
                nomeTextBox.Text = _relatorio.Nome;
            }

            excluirButton.Enabled = _relatorio.Existe;
        ...
        {
            codigoTextBox.Text = new PowerBIBO().Proximo().ToString();
            ativoCheckBox.Focus();
        }
        ...
        private void gravarButton_Click(object sender, EventArgs e)
        {
            ...
            _log.Descricao = (_relatorio.Existe ? "Alterou" : "Incluiu") + " o relatório " + codigoTextBox.Text +
                (_relatorio.Nome == nomeTextBox.Text ? "" : " [Nome] de " + _relatorio.Nome + " para " + nomeTextBox.Text) +
                (_relatorio.Ativo == ativoCheckBox.Checked ? "" : " [Ativo] de " + _relatorio.Ativo + " para " + ativoCheckBox.Checked);

            _relatorio.Id = Convert.ToInt32(codigoTextBox.Text);
            _relatorio.Ativo = ativoCheckBox.Checked;
            _relatorio.Nome = nomeTextBox.Text;
            
            if (!new PowerBIBO().Gravar(_relatorio))
            {
                new Notificacoes.Mensagem("Problemas durante a gravação." + Environment.NewLine + Publicas.mensagemDeErro, Publicas.TipoMensagem.Erro).ShowDialog();
                return;
            }

            _log.Tela = "TI - Power BI - Relatórios";
        ...
        private void excluirButton_Click(object sender, EventArgs e)
        {
            ...
            if (!new PowerBIBO().ExcluirRelatorios(_relatorio.Id))
            {
            ...
            Log _log = new Log();
            _log.IdUsuario = Publicas._usuario.Id;
            _log.Descricao = "Excluiu o relatório " + codigoTextBox.Text + " " + nomeTextBox.Text;
            _log.Tela = "TI - Power BI - Relatórios";
