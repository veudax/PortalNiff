    ...
    public partial class Retornar : Form
    {
        ...
        private void codigoTextBox_Validating(object sender, CancelEventArgs e)
        {
            ...
            else
            {
                ...
                _alterar = (_atendimento.Status == Publicas.StatusAtendimento.Finalizado || _atendimento.Retornou && _atendimento.IdUsuarioRetornoAoCliente == Publicas._usuario.Id);

                if (_atendimento.Retornou && _atendimento.IdUsuarioRetornoAoCliente != Publicas._usuario.Id)
                {
        ...
        private void gravarButton_Click(object sender, EventArgs e)
        {
            ...
            _atendimento.TextoRetornoAoCliente = respostaTextBox.Text;
            ...
            if (!new AtendimentoBO().Gravar(_atendimento, _atendimento, null))
            {
            ...
            _log.Descricao = "Retornou atendimento " + _atendimento.Codigo + " status " + statusComboBox.Text +
                (_alterar ? " [TextoRetornoAoCliente] de " + _atendimento.TextoRetornoAoCliente + " para " + respostaTextBox.Text : "");
            _log.Tela = "SAC - Retornou Ligação";
