    ...
    public partial class StatusPrazos : Form
    {
        public StatusPrazos()
        {
            ...
            if (Publicas._alterouSkin)
            {
                ...
                {
                    finalizadosGridGroupingControl.GridOfficeScrollBars = OfficeScrollBars.Office2010;
                    finalizadosGridGroupingControl.ColorStyles = ColorStyles.Office2010Black;
                    finalizadosGridGroupingControl.GridVisualStyles = GridVisualStyles.Office2016Black;
                    finalizadosGridGroupingControl.BackColor = Publicas._panelTitulo;
                    emAndamentoGridGroupingControl.GridOfficeScrollBars = OfficeScrollBars.Office2010;
                    emAndamentoGridGroupingControl.ColorStyles = ColorStyles.Office2010Black;
                    emAndamentoGridGroupingControl.GridVisualStyles = GridVisualStyles.Office2016Black;
                    emAndamentoGridGroupingControl.BackColor = Publicas._panelTitulo;
                    naoIniciadoGridGroupingControl.GridOfficeScrollBars = OfficeScrollBars.Office2010;
                    naoIniciadoGridGroupingControl.ColorStyles = ColorStyles.Office2010Black;
                    naoIniciadoGridGroupingControl.GridVisualStyles = GridVisualStyles.Office2016Black;
                    naoIniciadoGridGroupingControl.BackColor = Publicas._panelTitulo;
        ...
        private void StatusPrazos_Load(object sender, EventArgs e)
        {
