...
namespace Suportte.Biblioteca
{
    public partial class Categorias : Form
    {
        ...
        private void codigoTextBox_Validating(object sender, CancelEventArgs e)
        {
            ...
            {
                new Pesquisas.CategoriaLivros().ShowDialog();
            ...
            _categoria = new CategoriaLivrosBO().Consultar(Convert.ToInt32( codigoTextBox.Text));
        ...
        private void excluirButton_Click(object sender, EventArgs e)
        {
            ...
            if (!new CategoriaLivrosBO().Excluir(_categoria.Id))
            {
        ...
        private void gravarButton_Click(object sender, EventArgs e)
        {
            ...
            _categoria.Id = Convert.ToInt32(codigoTextBox.Text);
            _categoria.Descricao = nomeTextBox.Text;
            _categoria.Ativo = ativoCheckBox.Checked;

            if (!new CategoriaLivrosBO().Gravar(_categoria))
            {
        ...
        {
            codigoTextBox.Text = new CategoriaLivrosBO().Proximo().ToString();
            ativoCheckBox.Focus();
        }
