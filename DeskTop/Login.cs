    ...
    public partial class TelaLogin : Form
    {
        public TelaLogin()
        {
            ...
            if (Publicas._alterouSkin)
            {
                ...
                {
                    label1.ForeColor = Publicas._fonte;
                    label1.BackColor = Publicas._fundo;

                    pictureBox41.ImageLocation = @"Imagens\" + "logo_negativo.png";
                }
            }
        ...
        {
            esqueceuSenhaLabel.ForeColor = System.Drawing.Color.FromArgb(100, 151, 178);
        }
        ...
        private void esqueceuSenhaLabel_Click(object sender, EventArgs e)
        {
            ...
            _log.Descricao = "Esqueceu a senha. " + Environment.MachineName.ToUpper(); 
        ...
        private void acessarLoginButton_Click(object sender, EventArgs e)
        {
            ...
            retorno = new LoginBO().ValidarUsuario(usuarioLoginTextBox.Text, senhaLoginTextBox.Text, Publicas.stringConexao);
            ...
            {
                new Notificacoes.Mensagem("Senha inválida." + Environment.NewLine + Environment.NewLine
                    + "Se não lembra sua senha, clique em Esqueceu a senha." + Environment.NewLine 
                    + "Informe o CPF e clique no olho, que exibiremos sua senha durante 5 segundos."
            ...
            Log _log = new Log();
            _log.IdUsuario = Publicas._usuario.Id;
            _log.Descricao = "Efetuou login. " + Environment.MachineName.ToUpper(); 
            _log.Tela = "Principal - login";
        ...
        private void label1_MouseHover(object sender, EventArgs e)
        {
            ...
            label1.BackColor = (Publicas._TemaBlack ? Publicas._panelTituloFoco : Color.LightGray);
        }
        ...
        {
            // carrega o usuário logado no Windows
            usuarioLoginTextBox.Text = Environment.UserName;
            Publicas._usuario = new UsuarioBO().Consultar(usuarioLoginTextBox.Text);
            if (Publicas._usuario == null || !Publicas._usuario.Existe)
