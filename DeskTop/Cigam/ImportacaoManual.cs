...
{
    public partial class ImportacaoManual : Form
    {
        ...
        private void gravarButton_Click(object sender, EventArgs e)
        {
            ...
            List<Classes.Cigam> _lista = new CigamBO().ListarGlobus(_empresa.IdEmpresa, _empresa.CodigoEmpresaGlobus, inicialDateTimePicker.Value.Date, finalDateTimePicker.Value.Date);

            mensagemSistemaLabel.Text = "Gravando, aguarde...";
            Refresh();

            if (!new CigamBO().Gravar(_lista, _empresa.CodigoEmpresaGlobus, inicialDateTimePicker.Value.Date, finalDateTimePicker.Value.Date))
            {
                new Notificacoes.Mensagem("Problemas durante a gravação." + Publicas.mensagemDeErro, Publicas.TipoMensagem.Erro).ShowDialog();
                empresaComboBoxAdv.Focus();
            ...
            _log.Descricao = "Importou os dados da empresa " + empresaComboBoxAdv.Text + " na base "
            ...
            _log.Tela = "Contabilidade - Cigam - Importação de dados";
            ...
            new Notificacoes.Mensagem("Importação Finalizada com Sucesso.", Publicas.TipoMensagem.Alerta).ShowDialog();
