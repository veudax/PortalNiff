...
namespace Suportte.Notificacoes
{
    public partial class Aniversario : Form
    {
        public Aniversario()
        {
            ...
            mensagemAniversarioLabel.ForeColor = Color.Black;
        ...
        private void powerPictureBox_Click(object sender, EventArgs e)
        {
            ...
            Publicas._aniversario.Mensagem = mensagemAniversarioLabel.Text;
        ...
        private void Aniversario_Load(object sender, EventArgs e)
        {
            ...
            if (Publicas._aniversario.Existe)
                mensagemAniversarioLabel.Text = Publicas._aniversario.Mensagem;
            else
            {
                mensagens = new string[] { "", mensagemAniversarioLabel.Text, label1.Text, label2.Text };

                Random _aleatorio = new Random();

                int texto = _aleatorio.Next(1, 3);

                mensagemAniversarioLabel.Text = mensagens[texto];
            }
