...
decode(a.reembolso,'S','SIM','NÃO') reembolso, a.resumo,
decode(a.seguro,'S','SIM','NÃO') seguro, 
...
u.nome Solicitante, a.centrocusto, Decode(a.notafiscal, 'S', 'SIM','NÃO') TemNotaFiscal,
