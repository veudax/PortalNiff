...
Select Distinct Sum(Qtd_Ocorr) Qtd_Ocorr,
  ...
  From (
                   ...
                   From Frq_Ocorrencia  f,
                        ...
                        (Select Distinct a.Datarainfger,
                          ...
                          Where a.Codigoempresa = Ac.Codigoempresa
                            ...
                            And d.Statusdigit = 'N'
                            And d.Tipodigit = 'F'
                            And Trunc(a.Datarainfger) Between '01-jan-2017' And Sysdate
                         ) a
        ...
        Select 2 tipo, Qtd_Ocorr,
          ...
          From (Select Count(Fu.Nomefunc) Qtd_Ocorr,
                 ...
                 Where Fu.Codintfunc = a.Codintfunc
                   ...
                   --And Datetomin(Hora) Between Datetomin(Dmf.Entradigit) And Datetomin(Dmf.Saidadigit)
        ...
        Union All 
        ( 
        --3 Acidente fora do horário do fiscal depois do final da jornada
        ...
        Union All
        ( --4 Acidente fora do horário do fiscal Antes do inicio da jornada
        ...
        Union All
        (
           --5 Acidente fora do horário do fiscal depois do final da jornada dia seguinte
