...
Select CLASS,
    ...
    From (Select Sum(i.valoritemdoc) ValorPago, -- Pago
           ...
           Where c.coddoctocpg = i.coddoctocpg
             ...
             And c.pagamentocpg between Last_day(Add_Months(trunc(Sysdate),-2))+1 And Last_day(Add_Months(trunc(Sysdate),-1))
          ...
          Select 0 ValorPago, -- a Pagar
           ...
           Where c.coddoctocpg = i.coddoctocpg
             ...
             And c.VencimentoCPG between Last_day(Add_Months(trunc(Sysdate),-2))+1 And Last_day(Add_Months(trunc(Sysdate),-1))
            ...
            From pbi_Classif_FluxoCaixa F,
                 ((Select Sum(i.valoritemdoc) Mes1, 0 Mes2, 0 Mes3,
                     ...
                     From CPGDocto C,
                          ...
                          (Select d.PagamentoCPG Pagamento, d.codigoEmpresa, d.CodigoFl, i.codtpdespesa
                            ...
                            Where d.codigoempresa || d.codigofl In (11,12,21,31,41,51,61,91,131,261,263)
                              ...
                              And d.pagamentocpg between Add_Months(LAST_DAY(Trunc(SYSDATE)),-2)+1 And Add_Months(LAST_DAY(Trunc(SYSDATE)),-1) -- mes atual
                    ...
                    Where c.coddoctocpg = i.coddoctocpg
                      ...
                      And c.nrodoctocpg not Like 'AD-%'
                      And c.codmovtobco Is Not Null
                      And c.pagamentocpg between Add_Months(LAST_DAY(Trunc(SYSDATE)),-5)+1 And Add_Months(LAST_DAY(Trunc(SYSDATE)),-4) -- 3 meses antes
                  ...
                  (Select 0 Mes1, Sum(i.valoritemdoc) Mes2, 0 Mes3,
                    ...
                    Where c.coddoctocpg = i.coddoctocpg
                      ...
                      And c.codtpdoc Not In ('BOS')
                      And c.nrodoctocpg not Like 'AD-%'
                      And c.pagamentocpg between Add_Months(LAST_DAY(Trunc(SYSDATE)),-4)+1 And Add_Months(LAST_DAY(Trunc(SYSDATE)),-3) -- 2 Meses antes
                      And t.CodigoEmpresa = c.CodigoEmpresa
                      And t.CodigoFl = c.codigofl
                      And t.codtpdespesa = i.codtpdespesa
                     ...
                     From CPGDocto C,
                          ...
                          (Select d.PagamentoCPG Pagamento, d.codigoEmpresa, d.CodigoFl, i.codtpdespesa
                            ...
                            Where d.codigoempresa || d.codigofl In (11,12,21,31,41,51,61,91,131,261,263)
                              And i.codtpdespesa = f.CODTPDESPESA
                              And d.coddoctocpg = i.coddoctocpg
                              And d.pagamentocpg between Add_Months(LAST_DAY(Trunc(SYSDATE)),-2)+1 And Add_Months(LAST_DAY(Trunc(SYSDATE)),-1)
                            Group By d.PagamentoCPG, d.codigoEmpresa, d.CodigoFl, i.codtpdespesa) t
                    Where c.coddoctocpg = i.coddoctocpg
                      And d.codtpdespesa = i.codtpdespesa
                      And d.codtpdespesa = f.CODTPDESPESA
                      ...
                      And c.nrodoctocpg not Like 'AD-%'
                      And c.codmovtobco Is Not Null
                      And c.pagamentocpg between Add_Months(LAST_DAY(Trunc(SYSDATE)),-3)+1 And Add_Months(LAST_DAY(Trunc(SYSDATE)),-2) -- 1 mes antes
                      And t.CodigoEmpresa = c.CodigoEmpresa
                      And t.CodigoFl = c.codigofl
                      And t.codtpdespesa = i.codtpdespesa
