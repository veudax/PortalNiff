SELECT A.CODIGOINTPNEU,
  ...
  Case When a.DATACOMPRAPNEU < a.DataSUCATAPNEU Then DATASUCATAPNEU Else DATACOMPRAPNEU End Data,
  (SELECT Max(DATARETORNOSERVICOOS) 
     FROM PNE_SERVICOS_OS 
    WHERE DATARETORNOSERVICOOS BETWEEN TO_DATE('01/12/2018 00:00:00', 'DD/MM/YYYY HH24:MI:SS') and TO_DATE('31/12/2018 00:00:00', 'DD/MM/YYYY HH24:MI:SS') 
      And CODIGOINTPNEU = a.CODIGOINTPNEU ) DataServico,
   (SELECT Max(F.ENTRADASAIDANF)
      FROM BGM_NOTAFISCAL      F 
         , PNE_VENDAPNEU     G 
    WHERE F.CODINTNF    = G.CODINTNF 
      And CODIGOINTPNEU =  A.CODIGOINTPNEU
      AND F.ENTRADASAIDANF BETWEEN TO_DATE('01/12/2018 00:00:00', 'DD/MM/YYYY HH24:MI:SS') and TO_DATE('31/12/2018 00:00:00', 'DD/MM/YYYY HH24:MI:SS') ) DataVenda
FROM 
  PNE_CADASTROPNEU    A, 
  PNE_CADASTROMARCA   B, 
...
WHERE 
  ...
  (A.DATACOMPRAPNEU BETWEEN TO_DATE('01/12/2018 00:00:00', 'DD/MM/YYYY HH24:MI:SS')  and TO_DATE('31/12/2018 00:00:00', 'DD/MM/YYYY HH24:MI:SS') 
  or  A.DATASUCATAPNEU BETWEEN TO_DATE('01/12/2018 00:00:00', 'DD/MM/YYYY HH24:MI:SS') and TO_DATE('31/12/2018 00:00:00', 'DD/MM/YYYY HH24:MI:SS') 
  ...
  or  A.CODIGOINTPNEU IN (SELECT G.CODIGOINTPNEU FROM BGM_NOTAFISCAL      F 
                               , PNE_VENDAPNEU     G 
                           WHERE F.CODINTNF    = G.CODINTNF 
                             AND F.ENTRADASAIDANF BETWEEN TO_DATE('01/12/2018 00:00:00', 'DD/MM/YYYY HH24:MI:SS') and TO_DATE('31/12/2018 00:00:00', 'DD/MM/YYYY HH24:MI:SS') ))) 
  and  A.CODIGOFOGOPNEU  BETWEEN '      !'  and 'ZZZZZZZ'
