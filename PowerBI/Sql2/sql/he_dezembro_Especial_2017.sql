Create Or Replace View pbi_he_Dez1AnoBarras As
  select lpad(f.codigoempresa,3,'0') || '/' || lPad(Decode(f.codigoempresa,9, decode(f.codigofl, 2, 1, f.codigofl),f.codigofl),3,'0') EmpFil
     ...
     , ac.codevento
     , e.desceven evento
     , To_date('20/12/2017','dd/mm/yyyy') competacumu
     , ac.referacumu
     ...
     , ( Select codintfunc, to_char(competacumu,'mm/yyyy') mesAno, competacumu
           From ( Select ac2.codintfunc
                  ...
                  where ac2.codevento in (1,5)
                    ...
                    and ac2.competacumu between '26-nov-2017' And '20-dec-2017'
 ...
 where ac2.codintfunc = ac.codintfunc
   ...
   and ac.competacumu between '26-nov-2017' And '20-dec-2017'
Union All   
  select lpad(f.codigoempresa,3,'0') || '/' || lPad(Decode(f.codigoempresa,9, decode(f.codigofl, 2, 1, f.codigofl),f.codigofl),3,'0') EmpFil
     , f.CODAREA
     , F.descarea Area
     ...
     , ac.codevento
     , e.desceven evento
     , To_date('15/12/2017','dd/mm/yyyy') competacumu
     , ac.referacumu
     , trunc((( (trunc(ac.referacumu) * 60 ) + ( (ac.referacumu - trunc(ac.referacumu) )*100) ))/60,2) minutos
     , '12/2017' Periodo
     , '201712' PeriodoOrdem
     ...
     , ( Select codintfunc, to_char(competacumu,'mm/yyyy') mesAno, competacumu
           From ( Select ac2.codintfunc
                  ...
                  where ac2.codevento in (1,5)
                    ...
                    And ac2.codintfunc = f.codintfunc
                    and fr2.competacumu = ac2.competacumu
                    and ac2.competacumu between '21-nov-2017' And '15-dec-2017'
                  group by ac2.codintfunc
                   ) ac2
       ) ac2
     , PBI_vwFuncionarios f
 ...
 where ac2.codintfunc = ac.codintfunc
   ...
   and e.codevento = ac.codevento
   and f.CODAREA In (20, 30, 40, 80)
   And f.codigoempresa || f.codigofl In (11,12,61,261)
   and ac.codevento in (3,375,3,202,281,222,201,202,277,598,443,202,652,637,283)
   and ac.competacumu between '21-nov-2017' And '15-dec-2017'
Union All
  select lpad(f.codigoempresa,3,'0') || '/' || lPad(Decode(f.codigoempresa,9, decode(f.codigofl, 2, 1, f.codigofl),f.codigofl),3,'0') EmpFil
     , f.CODAREA
     , F.descarea Area
     ...
     , ( Select codintfunc, to_char(competacumu,'mm/yyyy') mesAno, competacumu
           From ( Select ac2.codintfunc
                  ...
                  where ac2.codevento in (1,5)
                    ...
                    And ac2.codintfunc = f.codintfunc
                    and fr2.competacumu = ac2.competacumu
                    and ac2.competacumu between '21-nov-2017' And '20-dec-2017'
                  group by ac2.codintfunc
                   ) ac2       ) ac2
 ...
 where ac2.codintfunc = ac.codintfunc
   ...
   and e.codevento = ac.codevento
   and f.CODAREA In (20, 30, 40, 80)
   And f.codigoempresa || f.codigofl In (21,31,41,131,263)
   and ac.codevento in (3,375,3,202,281,222,201,202,277,598,443,202,652,637,283)
   and ac.competacumu between '21-nov-2017' And '20-dec-2017'
