---Create Or Replace View PBI_FaturamentoGeralVendas As
     Select Last_day(g.dat_prest_contas) Data, a.cod_agencia
...
--         And l.codigotplinha = 0
         And g.cod_empresa || g.CodigoFl In 41 --(11,12,21,31,41,61,91,131,261,263)
         And a.cod_agencia = '99997'
         And g.dat_prest_contas BETWEEN ADD_MONTHS(Trunc(Sysdate,'rr'), -1) AND Last_day(trunc(sysdate))
       Group By Last_day(g.dat_prest_contas)
           , a.cod_empresa, a.cod_agencia
           , a.codigofl       
