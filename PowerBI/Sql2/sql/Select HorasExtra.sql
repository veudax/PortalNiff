...
--    and dm.codevento in (3,375,3,202,281,222,201,202,277,598,443,202,652,637,283)
    and dm.dtdigit between '01-jan-2016' and (ADD_MONTHS(LAST_DAY(TO_DATE(TO_CHAR(SYSDATE,'DD/MM/YYYY'),'DD/MM/YYYY'))+0, -1))
  union all
 select '001/001 - EOVG DUTRA' Empresa
      , f.CODAREA
      , a.descarea Area
