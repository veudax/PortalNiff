...
Select Last_day(g.dat_prest_contas) Data
  ...
  From t_arr_Guia g, t_arr_detalhe_guia d, bgm_cadlinhas L, t_Trf_Tipopagto p, t_Trf_Agencia a,
    ( Select d.descexterno, d.codempresaglobus Empresa, d.codfilialglobus Filial, d.codglobus 
 ...
 Where a.flg_status = 'O'
   ...
   And g.dat_prest_contas BETWEEN ADD_MONTHS(Trunc(Sysdate,'rr'), -24) AND Last_day(trunc(sysdate))
