create or replace view vw_niff_relmutuo as
Select EmpFil, To_date('01/' || SubStr(Periodosaldo,5,2) || '/' || SubStr(PeriodoSaldo,1,4),'dd/mm/yyyy') Data
     ...
     , Abs(Sum(EOVG)) + Abs(Sum(Rapido)) + Abs(Sum(Campibus)) +
       Abs(Sum(Aruja)) + Abs(Sum(ABC)) + Abs(Sum(RIBE)) + Abs(Sum(Cisne)) + Abs(Sum(VGI)) + Abs(Sum(VUG)) Consolidado
     , Abs(Sum(EOVG_C)) EOVG_C
     , Abs(Sum(Rapido_C)) Rapido_C
     , Abs(Sum(Ribe_C)) RibeC
     , Abs(Sum(EOG_C)) EOG_C
     , Abs(Sum(VUG_C)) VUG_C
     , Abs(Sum(Felbek_C)) Felbek
     , Abs(Sum(EOVG)) + Abs(Sum(Rapido)) + Abs(Sum(Campibus)) +
       Abs(Sum(Aruja)) + Abs(Sum(ABC)) + Abs(Sum(RIBE)) + Abs(Sum(Cisne)) + Abs(Sum(VGI)) + Abs(Sum(VUG)) +
