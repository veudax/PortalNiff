...
Select
  ...
  F.Rsocialforn         Recapador,
  FC_TRAZKMCUSTOPNEU(A.CODIGOINTPNEU,99,'K',NULL, TO_DATE('31/12/2018 00:00:00', 'DD/MM/YYYY HH24:MI:SS') ,'N' ,'A' ) TOTAL_KM,
  fc_pbi_DataPneus(0,A.CODIGOINTPNEU) Data,  '1º' Tipo,
...
Select
  ...
  F.Rsocialforn         Recapador,
  FC_TRAZKMCUSTOPNEU(A.CODIGOINTPNEU,99,'K',NULL, TO_DATE('31/12/2018 00:00:00', 'DD/MM/YYYY HH24:MI:SS') ,'N' ,'A' ) TOTAL_KM,
  fc_pbi_DataPneus(0,A.CODIGOINTPNEU) Data,  '2º' Tipo,
...
Select
  ...
  F.Rsocialforn         Recapador,
  FC_TRAZKMCUSTOPNEU(A.CODIGOINTPNEU,99,'K',NULL, TO_DATE('31/12/2018 00:00:00', 'DD/MM/YYYY HH24:MI:SS') ,'N' ,'A' ) TOTAL_KM,
  fc_pbi_DataPneus(0,A.CODIGOINTPNEU) Data,  '3º' Tipo,
...
Select
  ...
  F.Rsocialforn         Recapador,
  FC_TRAZKMCUSTOPNEU(A.CODIGOINTPNEU,99,'K',NULL, TO_DATE('31/12/2018 00:00:00', 'DD/MM/YYYY HH24:MI:SS') ,'N' ,'A' ) TOTAL_KM,
  fc_pbi_DataPneus(0,A.CODIGOINTPNEU) Data,  '4º' Tipo,
...
Select
  ...
  F.Rsocialforn         Recapador,
  FC_TRAZKMCUSTOPNEU(A.CODIGOINTPNEU,99,'K',NULL, TO_DATE('31/12/2018 00:00:00', 'DD/MM/YYYY HH24:MI:SS') ,'N' ,'A' ) TOTAL_KM,
  fc_pbi_DataPneus(0,A.CODIGOINTPNEU) Data,  '5º' Tipo,
