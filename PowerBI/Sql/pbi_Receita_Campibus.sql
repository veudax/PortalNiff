create or replace view pbi_arr_receita_campibus as
...
FROM
  ...
  (select Distinct t.valor, t.data From pbi_radar_operacional t where grupo = 'Dias uteis' And t.empfil = '009/001') d,
...
GROUP BY
  ...
  d.valor
Union All
Select Distinct  '009/001 - CAMPIBUS LTDA' empresa
     , '009/001' EmpFil
     , Data
     , 0 VLR_FATURAMENTO
     , 0 PASSAGEIROS
