create or replace view pbi_arr_receita_eovglavras as
...
FROM
  ...
  (select Distinct t.valor, t.data From pbi_radar_operacional t where grupo = 'Dias uteis' And t.empfil = '001/002') d,
...
GROUP BY
  ...
  t.dataPonte,
  d.valor
-- Novas tabelas feriados e emendas -- 2019 em diante
...
Union All
Select Distinct   '001/002 - EOVG LAVRAS' empresa
     , '001/002' EmpFil
     , Data
     , 0 VLR_FATURAMENTO
     , 0 PASSAGEIROS
