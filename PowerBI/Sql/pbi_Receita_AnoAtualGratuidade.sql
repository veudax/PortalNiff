CREATE OR REPLACE VIEW PBI_ARR_RECEITA_17GRAT AS
Select empresa, empfil, COD_TIPOPAGTO, NOM_DESCRICAO, VLR_FATURAMENTO, PASSAGEIROS,
  Case When Data > trunc(Sysdate) Then
    trunc(Sysdate) Else Data End Data
From (
...
--  G.DAT_VIAGEM_GUIA   BETWEEN '01-JAN-2017' AND '31-dec-2017'
  g.dat_prest_contas  BETWEEN Trunc(Sysdate,'rr') AND Last_day(ADD_MONTHS(Trunc(Sysdate,'rr'), +11))
...
WHERE
  ...
  V.COD_SEQ_GUIA      = A.COD_SEQ_GUIA      AND
  G.COD_SEQ_GUIA      = V.COD_SEQ_GUIA      AND
--  G.DAT_VIAGEM_GUIA   BETWEEN Trunc(Sysdate,'rr') AND '31-dec-2017'
  g.dat_prest_contas  BETWEEN Trunc(Sysdate,'rr') AND Last_day(ADD_MONTHS(Trunc(Sysdate,'rr'), +11))
...
WHERE
  ...
  V.COD_SEQ_GUIA      = A.COD_SEQ_GUIA      AND
  G.COD_SEQ_GUIA      = V.COD_SEQ_GUIA      AND
--  G.DAT_VIAGEM_GUIA   BETWEEN Trunc(Sysdate,'rr') AND Last_day(ADD_MONTHS(Trunc(Sysdate,'rr'),11))
  g.dat_prest_contas  BETWEEN Trunc(Sysdate,'rr') AND Last_day(ADD_MONTHS(Trunc(Sysdate,'rr'),11))
