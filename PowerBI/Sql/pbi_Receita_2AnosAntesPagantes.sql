...
--  G.DAT_VIAGEM_GUIA   BETWEEN ADD_MONTHS(Trunc(Sysdate,'rr'), -24) AND '31-dec-2015'
  g.Dat_Prest_Contas  BETWEEN ADD_MONTHS(Trunc(Sysdate,'rr'), -24) AND Last_day(ADD_MONTHS(Trunc(Sysdate,'rr'), -13))
...
WHERE
  ...
  V.COD_SEQ_GUIA      = A.COD_SEQ_GUIA      AND
  G.COD_SEQ_GUIA      = V.COD_SEQ_GUIA      AND
--  G.DAT_VIAGEM_GUIA   BETWEEN ADD_MONTHS(Trunc(Sysdate,'rr'), -24) AND Last_day(ADD_MONTHS(Trunc(Sysdate,'rr'), -13))
  g.Dat_Prest_Contas  BETWEEN ADD_MONTHS(Trunc(Sysdate,'rr'), -24) AND Last_day(ADD_MONTHS(Trunc(Sysdate,'rr'), -13))
