               ...
               decode( s.periodosaldo, (Select To_Char(Min(data_ini_ex),'yyyymm') From ctbexerc)
                     ...
                     , Sum( (Select Sum(s1.vldebitosaldo - s1.vlcreditosaldo)
                              ...
                              Where s1.nroplano = s.nroplano
                                ...
                                And S1.Periodosaldo Between (Select To_Char(Min(data_ini_ex),'yyyymm') From ctbexerc) And s.Periodosaldo ))) Neida,
               0 JoseRoberto,
               0 Thiago,
               0 Roque,
               0 Christiane,
               ...
               decode( s.periodosaldo, (Select To_Char(Min(data_ini_ex),'yyyymm') From ctbexerc)
                     ...
                     , Sum( (Select Sum(s1.vldebitosaldo - s1.vlcreditosaldo)
                              ...
                              Where s1.nroplano = s.nroplano
                                ...
                                And s1.codigoempresa = s.codigoempresa
                                And s1.codigofl = s.codigofl
                                And S1.Periodosaldo Between (Select To_Char(Min(data_ini_ex),'yyyymm') From ctbexerc) And s.Periodosaldo ))) JoseRoberto,
               0 Thiago,
               0 Roque,
               0 Christiane,
               3 Ordem
               ...
               decode( s.periodosaldo, (Select To_Char(Min(data_ini_ex),'yyyymm') From ctbexerc)
                     ...
                     , Sum( (Select Sum(s1.vldebitosaldo - s1.vlcreditosaldo)
                              ...
                              Where s1.nroplano = s.nroplano
                                ...
                                And s1.codigoempresa = s.codigoempresa
                                And s1.codigofl = s.codigofl
                                And S1.Periodosaldo Between (Select To_Char(Min(data_ini_ex),'yyyymm') From ctbexerc) And s.Periodosaldo ))) Thiago,
               0 Roque,
               0 Christiane,
               3 Ordem
          From Ctbsaldo s, ctbconta c
               ...
               decode( s.periodosaldo, (Select To_Char(Min(data_ini_ex),'yyyymm') From ctbexerc)
                     ...
                     , Sum( (Select Sum(s1.vldebitosaldo - s1.vlcreditosaldo)
                              ...
                              Where s1.nroplano = s.nroplano
                                ...
                                And s1.codigoempresa = s.codigoempresa
                                And s1.codigofl = s.codigofl
                                And S1.Periodosaldo Between (Select To_Char(Min(data_ini_ex),'yyyymm') From ctbexerc) And s.Periodosaldo ))) Roque,
               0 Christiane,
               3 Ordem
          From Ctbsaldo s, ctbconta c
         Where s.nroplano = 10
               ...
               decode( s.periodosaldo, (Select To_Char(Min(data_ini_ex),'yyyymm') From ctbexerc)
                     ...
                     , Sum( (Select Sum(s1.vldebitosaldo - s1.vlcreditosaldo)
                              ...
                              Where s1.nroplano = s.nroplano
                                ...
                                And s1.codigoempresa = s.codigoempresa
                                And s1.codigofl = s.codigofl
                                And S1.Periodosaldo Between (Select To_Char(Min(data_ini_ex),'yyyymm') From ctbexerc) And s.Periodosaldo ))) Christiane,
               3 Ordem
          From Ctbsaldo s, ctbconta c
         Where s.nroplano = 10
           And s.periodosaldo Between To_Char(Add_Months(Trunc(Sysdate, 'rr'), -12), 'yyyymm')
