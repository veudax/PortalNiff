CREATE OR REPLACE VIEW PBI_ARR_RECEITA_16GRAT AS
(Select -- 1 ano do ano atual
...
--  G.DAT_VIAGEM_GUIA   BETWEEN ADD_MONTHS(Trunc(Sysdate,'rr'), -12) AND Last_day(ADD_MONTHS(Trunc(Sysdate,'rr'), -13))
  g.dat_prest_contas Between ADD_MONTHS(Trunc(Sysdate,'rr'), -12) And Last_day(ADD_MONTHS(Trunc(Sysdate,'rr'), -1))
...
WHERE
  ...
  G.COD_SEQ_GUIA      = V.COD_SEQ_GUIA      AND
--  G.DAT_VIAGEM_GUIA   BETWEEN ADD_MONTHS(Trunc(Sysdate,'rr'), -12) AND Last_day(ADD_MONTHS(Trunc(Sysdate,'rr'), -13))
  g.dat_prest_contas Between ADD_MONTHS(Trunc(Sysdate,'rr'), -12) And Last_day(ADD_MONTHS(Trunc(Sysdate,'rr'), -13))
