create or replace view pbi_chamados_finalizados as
Select g.descricao categoria, c.numero, d.descricao departamento,
       Decode(c.status,'F','Finalizado','N','Aberto','E','Aguardando Analista','P','Aguardando Solicitante',
                       'D','Em Desenvolvimento','C','Cancelado','A','Aguardando Terceiros','U','Aguardando Autorização', 'Reaberto') Status,
     ...
     , trunc(decode(status, 'C', tc.DataFinal, 'F', tc.DataFinal, tc.DataInicio)) Data
...
-- And numero = '201910-0303'
 Group By g.descricao, c.status, t.nome, m.nome, u.nome, a.nome, c.avaliacao, c.avaliacaosolicitante
      ...
      , e.nomeabreviado, c.prazodesenvolvimento, d.descricao, eu.nomeabreviado
