create or replace view pbi_arr_receita_vugdutra as
...
FROM
  ...
  (select Distinct t.valor, t.data From pbi_radar_operacional t where grupo = 'Dias uteis' And t.empfil = '026/001') d,
...
GROUP BY
  ...
  d.valor
Union All
Select Distinct  '026/001 - VUG DUTRA' empresa
     , '026/001' EmpFil
     , Data
     , 0 VLR_FATURAMENTO
     , 0 PASSAGEIROS
