create or replace view pbi_arr_receita_vugbebedouro as
...
GROUP BY
  ...
  d.valor
Union All
Select Distinct  '026/003 - VUG BEBEDOURO' empresa
     , '026/003' EmpFil
     , Data
     , 0 VLR_FATURAMENTO
     , 0 PASSAGEIROS
...
FROM
  ...
  (select Distinct t.valor, t.data From pbi_radar_operacional t where grupo = 'Dias uteis' And t.empfil = '026/003') d,
